...
const [isModalOpen, setIsModalOpen] = useState(false);
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.image) {
      formDataToSend.append('imageFile', formData.image); // Send image file
    }
 ...
 const handleImageChange = (e) => {
  ...
  if (file) {
    ...
    setIsModalOpen(true); // mở modal sau khi chọn
  }
};
  ...
  return (
    ...
    >
      ...
      {/* Nếu đã chọn ảnh -> chia đôi 2 nút */}
      {formData.image ? (
