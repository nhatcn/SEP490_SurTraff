...
const AddVehicle = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    color: '',
    brand: '',
    image: null, // Removed TypeScript annotation 'as File | null' for JavaScript compatibility
  });
  ...
  const validateForm = () => {
    ...
    } else if (existingPlates.some(plate => plate.toLowerCase() === formData.licensePlate.trim().toLowerCase())) {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <motion.div variants={inputVariants} whileFocus="focused" className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="e.g., 30A-12345, 64-B1-12345, CUSTOM123, or NG-123-45"
